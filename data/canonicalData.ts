...
Ayúdame a hacer la cama	{empty}	{empty}	{empty}	<svg id="pictogram" xmlns="http://wwww3org/2000/svg" version="11" viewBox="0 0 100 100" role="img" class="hc"     aria-labelledby="title desc" lang="en-NZ" tabindex="0" focusable="true" data-domain="home" data-intent="directive"     data-utterance="Make the bed" style="font-size:12px">      <title id="title">Make the bed (directive)</title>     <desc id="desc">         A person standing beside a single bed: frame, mattress, pillow and sheet visible         Intended meaning: action “make” applied to object “bed”; everyday domestic routine     </desc>      <metadata id="mf-accessibility">         {         "schema": "https://pictosnet/schemas/pictogram-accessibility/v1",         "utterance": {         "text": "Make the bed",         "speechAct": "directive",         "language": "en-NZ",         "domain": "Activities of Daily Living"         },         "nsm": {         "primes": ["DO","SOMEONE","SOMETHING","PLACE","NOW"],         "gloss": "SOMEONE DO something to bed NOW so bed is good to sleep"         },         "concepts": [         {"id": "bed", "role": "patient", "kind": "OBJECT"},         {"id": "person", "role": "agent", "kind": "HUMAN"},         {"id": "make", "role": "action", "kind": "VERB"}         ],         "accessibility": {         "readingOrder": ["title","desc","g-person","g-bed"],         "keyboard": {"tabStops": ["g-person","g-bed"]},         "contrast": {"preferred": "AA", "strokeMin": 2},         "motion": {"noMotionDefault": true}         },         "provenance": {         "author": "PictoNet",         "license": "CC BY 40",         "version": "10-gs"         }         }     </metadata>      <defs>         <style>             /* Base */             f,             k {                 stroke-linejoin: round;                 stroke-width: 1ex;             }              f {                 fill: #fff;                 stroke: #000;             }              k {                 fill: #000;                 stroke: #fff;             }              /* Alto contraste activado en el propio */             svghc f {                 fill: #fff;                 stroke: #000;                 stroke-width: 4ex;             }              svghc k {                 fill: #000;                 stroke: #fff;                 stroke-width: 3ex;             }              /* Alto contraste activado en el contenedor HTML padre: */             hc svg f {                 fill: #fff;                 stroke: #000;                 stroke-width: 4ex;             }              hc svg k {                 fill: #000;                 stroke: #fff;                 stroke-width: 3ex;             }         </style>     </defs>      <!-- BED (Patient) -->     <g id="g-bed" role="group" class="hc f" tabindex="0" aria-label="Bed, the object of the action" data-role="patient"         data-concept="bed">         <path id="bed_frame" d="M866,661l67,109v71h-51v51c0,9-7,16-16,16h-23c-9,       0-16-7-16-16v-51h-382v51c0,9-7,16-16,16h-23c-9,       0-16-7-16-16v-51h-51v-71l67-109v-185c0-13,11-24,       24-24h413c13,0,24,11,24,24v185h-1Z" aria-label="Bed frame" />         <path id="mattress" d="M859,786h-444c-3,0-54-24-54-54v-19c0-157-3,       18-4l77-68c1-9,23-14,36-14h29c13,0,265,36,14l77,       68c12,1,18,25,18,4v19c0,3-24,54-54,54Z" aria-label="Mattress" />         <path id="pillow" d="M522,535h224c23,0,41,18,41,4h0c0,22-18,4-41,       4h-224c-23,0-41-18-41-4h0c0-22,18-4,41-4Z" aria-label="Pillow" />         <path id="sheet" d="M506,396c21,13,153,55,153,55,0,0-13,96-39,       125-63,71-172,83-207,102s-34,978,       108c-763-69-89-42-113s79-67,107-117c41-74,23-138,2-16Z"             aria-label="Top sheet, to be pulled and smoothed" />     </g>      <!-- PERSON (Agent) -->     <g id="g-person" role="group" class="hc k" tabindex="0" aria-label="Person, the agent who makes the bed"         data-role="agent" data-concept="person">         <path id="arm" d="M299,375l42,78,67,37c116,15,217,32h0c-68-17,       11-267l-91-39-41-64" aria-label="Arm reaching towards bed" />         <path id="body" d="M29,905l-492-5-356-3,189-42,       171h-5l43-1976-194c2-212-326-5,0,0,8-37,2-69s35-72,       52-93l23-27c24-28,67-31,95-7l21,18,76,92c89,18,16,       3,2l10,3c144,22,2,16,34h0c-5,11-17,18-29,       15l-137-33-91-75-49,75,4,455h0Z" aria-label="Torso and legs" />         <circle id="head" cx="389" cy="199" r="55" aria-label="Head" />     </g>      <!-- Hidden caption for environments that expose <desc> poorly -->     <text x="-9999" y="-9999" aria-hidden="true">Make the bed</text>  </svg>
...
Tengo fiebre y necesito descansar	{empty}	{empty}	{empty}	{empty}
...
Quiero jugar con mis muñecos	{empty}	{empty}	{empty}	{empty}
